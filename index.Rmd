...
If you want to use Ubuntu 18.04, follow [this guide](https://linuxhint.com/install_ubuntu_18-04_virtualbox/) to set it up manually, or download a premade VirtualBox VDI image of Ubuntu 18.04 64-bit from [OSBoxes](https://www.osboxes.org/ubuntu/#ubuntu-1804-vbox) and then follow the [OSGeo Live guide](https://live.osgeo.org/en/quickstart/virtualization_quickstart.html) to set it up.
...
Download the ISO image of either [OSGeo Live](https://live.osgeo.org/en/download.html) or [Ubuntu 18.04](http://releases.ubuntu.com/18.04/), and write it onto a USB stick. There are several programs to do so depending on your operating system, e.g. [Rufus](https://tutorials.ubuntu.com/tutorial/tutorial-create-a-usb-stick-on-windows) on Windows.
...
cd bionic       ## In case you're running Ubuntu 18.04
