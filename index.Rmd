...
For the geo-scripting course (2016) we recommend you to work via a Linux environment as there all open-source tools and scripting languages (Python!) can more easily be installed. As such, in the PC labs we will work via *VMware Workstation Player*, from which you are able to start up a Linux environment (http://live.osgeo.org/). We will provide this `linux version` (also called virtual machine), which you can open via VMware Workstation Player at the start of the Geo-scripting course.

In case you just want to use R, you can continue and still choose to work on windows (see below). 
For Python programming we will work within a Linux OSGEO environment.

## VMware Workstation Player

See here http://www.vmware.com/products/workstation/

You can download it, and use it for free! We will provide more information during the lessons (lesson 2 and 3).
...
See for more info also http://live.osgeo.org/en/index.html.
